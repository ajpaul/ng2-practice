...
var EventService = (function () {
    ...
    //we are returning a subject, not an array! The subject is generic, so the array is inside the subject
    EventService.prototype.getEvents = function () {
        var subject = new RX_1.Subject();
        setTimeout(function () { subject.next(EVENTS); subject.complete(); }, 2000);
        return subject;
    };
    ...
    EventService.prototype.searchSessions = function (searchTerm) {
        ...
        var emitter = new core_1.EventEmitter(true); //true = emit asynchronously
        //simulate http for now
        setTimeout(function () {
